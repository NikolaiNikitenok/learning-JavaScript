...
// let a = prompt('Введи сторону квадрата: ');
// let s = a * a;
// alert("Площадь квадрата = " + s);

// let a = prompt('Введи первую сторону прямоугольника: ');
// let b = prompt('Введи вторую сторону прямоугольника: ');
// let s = a * b;
...
// let tc = prompt('Введи температуру в градусах по Цельсию: ');
